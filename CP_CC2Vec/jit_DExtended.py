...
def read_args():
    ...
    parser.add_argument('-save-dir', type=str, default='snapshot_ext', help='where to save the snapshot')
    parser.add_argument('-save-file', type=str, default='./snapshot_ext/QT-results.txt', help='where to save the results')
    # CUDA
