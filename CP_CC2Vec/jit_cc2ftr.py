...
def read_args():
    ...
    parser.add_argument('-model_nr', type=int, help='the id of the identically trained models')
    ...
    parser.add_argument('-save-file', type=str, default='./snapshot/QT-results.txt', help='where to save the results')
